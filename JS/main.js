...
function scrollTop(){
    ...
    // When the scroll is higher than 560 viewport height, add the scroll top
...
if(selectedTheme){
    // if the validation is fulfilled, we ask  what issue was to know if we activated or deactivated the dark mode
...
themeButton.addEventListener('click', ()=>{
    ...
    // We save the theme and icon that the user chose
